...
public class CourseUpdateRequest {
    ...
    public static Course convertToCourse(CourseUpdateRequest request) {
    ...
    public static void validUpdateCourseRequest(CourseUpdateRequest request) throws CustomException {
