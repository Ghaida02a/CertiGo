...
public class QuestionUpdateRequest {
    ...
    // convert DTO → Entity
    public static Question convertToQuestion(QuestionUpdateRequest request) {
    ...
    // validation
    public static void validateQuestion(QuestionUpdateRequest request) throws CustomException {
